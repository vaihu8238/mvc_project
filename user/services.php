 ...
 <div id="service"  class="service">
         <div class="container">
            ...
            foreach($cate_arr as $cate)
               ...
               <div class="card">
               <img src="images/thr1.png" height="100" width="100" alt="#"/>
                  <div class="card-body">
                   <button><h3 class="card-title"><a class="btn btn-danger" href="subcategory?btn_cate_id=<?php echo $cate->cate_id;?>"><?php  echo $cate->cate_name; ?></a></h3></button>
                  </div>
               </div>
               </div>
      </div>
           ...
           <!-- <div class="row">
               <div class="col-md-4">
                  <div id="hover_chang" class="service_box">
                     ...
                     <h3><a href="subcategory?btn_cate_id=<?php echo $cate->cate_id ?>"><?php  echo $cate->cate_name; ?></a></h3><br>
                     
                      <p>we are use cosmatics product of this compnies: <br>
                    - shree cosmatics <br>
                    - MAC Cosmetic <br>
                    - Glamour glow <br>
                    - coty <br>
                    ...
                    -nail-polis <br>
                    -jel-polis <br>
                    -all type of nail designs and extentions availabele <br>

                    we are using the top brands product for your sckin protection / helth. 
               ...
               <div class="col-md-4">
                  <div id="hover_chang" class="service_box">
                  <a href="appointment.php"> <i><img src="images/thr.png" alt="#"/></i>
                     <h3>mack-up / mackover</h3><br>
                     <p>-party mack-over <br>
                        -bridal-work  / bridal packages<br>
                        -sider mackover <br>
                        -ordinary mack-up <br>
                        -simple mack-up <br>
                        -profetional mackover <br>
                        -waterproof mack-up <br>
                        -air-brush mackover <br>
               ...
               <div class="col-md-4">
                  <div id="hover_chang" class="service_box">
                  <a href="appointment.php"><i><img src="images/thr2.png" alt="#"/></i>
                     <h3>hairdressing</h3>
                     <p>all type of hair dressing available <br>                     
                    </p>
                  </div></a>
               </div>
            ...
            <div class="col-md-4">
                  <div id="hover_chang" class="service_box">
                  <a href="appointment.php"><i><img src="images/thr1.png" alt="#"/></i>
                     <h3>Body-care</h3>
                     <p>-wex(simple / cream / brazil / leepo stick) hand,lag,full-body <br>
                        -full body massage / spa <br>
                        -madiqure / padicure / detaine<br>                        
                    </p>
                  </div></a>
               </div>
               <div class="col-md-4">
                  ...
                  <a href="appointment.php"><i><img src="images/thr1.png" alt="#"/></i>
                     <h3>sckin-care</h3>
                     <p> -facial(all type of facial available) <br>
                         -cleanup <br>
                         -ibrow <br>
               ...
               <div class="col-md-4">
                  ...
                  <a href="appointment.php"><i><img src="images/thr2.png" alt="#"/></i>
                     <h3>hair-care</h3>
                     <p> -permenent strait <br>
                     -high light(all color available) <br> 
                     -hair smoothning <br>
                     -hair color <br>
                     -hair spa <br>
                     -hair wash <br>
                     -hair ceratin <br>
                     -hair cut (all type of cut) <br>
                     </p>
                  </div></a>
               </div>
            </div>-->
