         ...
         <div class="card-group">
            <div class="card">
               <!-- <img src="images/tes.png" height="100" width="100" alt="#"/> -->
                  <div class="card-body">
                  <!--  <a href="singleproduct?btn_prd_id=<?php echo $prd->sp_id ?>"> -->
                      <!-- <input type="hidden" name="cate_id" value="<?php echo $prd->scate_id;?>">
							 <input type="hidden" name="pro_id" value="<?php echo $prd->sp_id;?>"> -->
                        <h4><b>price :<?php  echo $prd->sp_price; ?> </b></h4>
                        <h3 class="btn btn-danger"><?php  echo $prd->sp_name; ?></h3><br><br>
                        Qty : <input type="number" name="pro_qty" min="1" max="5" value="1">
                        <button><h3><a class="btn btn-danger" href="singleproduct?singleprd_id=<?php echo $prd->sp_id;?>">view</a></h3></button>
                  <div>
                     <h4><b>Plese note : <?php  echo $prd->descripation; ?></b></h4>
                  </div>
                 </div>
            </div>
         </div>
