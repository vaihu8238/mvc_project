...
<header>
 ...
 <div id="service"  class="service">
         <div class="container">
            ...
            <?php
            foreach($psubcate_arr as $pscate)
               {
               ?>
               ...
               <img src="images/tes.png" height="100" width="100" alt="#"/>
                  <div class="card-body">
                   <button><h3><a class="btn btn-danger" href="psubproduct?pspro_id=<?php echo $pscate->psub_id;?>"><?php  echo $pscate->pscate_name; ?></a></h3></button>
                  </div>
               </div>
               </div></center>
      </div>
