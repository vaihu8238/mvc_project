                            ...
                            <table class="table table-dark">
                                ...
                                <tbody>
                                       ...
                                       ?>
                                          <tr>
                                                <td>image</td>
                                                <td><?php echo $u->sp_name; ?></td>
                                                <td><?php echo $u->sp_price; ?></td>
                                                ...
                                                <td class="cart-product-quantity" width="130px">
                                                   <div class="input-group quantity">
                                                         ...
                                                         <input type="text" class="qty-input form-control" maxlength="2" max="10" value="<?php echo $u->qty?>">
                                             ...
                                             <td>
                                                   ...
                                                   <a href="deleteCart?delId=<?php echo $u->scart_id?>">
                                          ...
                                          <tr>
                                             <td>
                                                <a href="appoint" class="btn btn-primary">next</a>
                                             </td>
                                          </tr>
                                </tbody>
                            </table>
