                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <table class="table table-dark">
                                ...
                                ?>
                                    ...
                                    <td><?php echo $staff->work_type?></td>
                                   
    
                                    <td>
                                        <a  href="/project/admin/edit-staff?update_id=<?php echo $staff->s_id; ?>">
                                        <i class="fa fa-pen fa-2x" aria-hidden="true"></i>
                                        </a>&nbsp;
                                    
                                    
                                        <a  href="/project/admin/delete-staff?del_id=<?php echo $staff->s_id; ?>">
